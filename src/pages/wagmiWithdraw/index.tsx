...
import {useStakeContractWrite, useStakingBalance, useUser, useWithdrawAmount} from "@/utils/useStakeContractWagmi";
...
const Withdraw = () => {
    ...
    const handleUnStake = useCallback(async () => {
        ...
        try {
            ...
            const hash = await useUnstake(Pid, parseUnits(amount, 18));
            await waitForTransactionReceipt(data, { hash: hash });
    ...
    const handleWithdraw = useCallback(async () => {
        ...
        try {
            ...
            const hash = await useWithdraw(Pid);
            await waitForTransactionReceipt(data, { hash: hash });
